...
class Photo {
  ...
  ` 
<a href="` +this.url+`galeryGrdeTaille/` + this.medias + `" onclick="return false;" class="light-link" data-sub-html=" <h4 class='titleInGallery'>`+ this.title + ` - `+ this.price+`€</h4>"> <img src="`+ this.url + this.medias + `" alt="`+ this.alt_text+  `"/><div class="infoContenair"><div class="titleMedias"> `+ this.title+ `</div><div class="likes"><div aria-label="nombre de likes" id="likes_`+ this.id +`"> ` +   this.like + `</div>
